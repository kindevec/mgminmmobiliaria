...
export function InvestmentCalculator() {
  ...
  return (
    <div className="w-full bg-slate-950 text-white rounded-3xl p-6 sm:p-10 lg:p-12 border border-slate-800 shadow-2xl relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 relative z-10 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-xl border border-slate-700 bg-slate-900/90 px-4 py-3 text-sm font-semibold text-white focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 transition-all cursor-pointer"
            >
              {availableOrAll.map((lot) => (
                <option key={lot.code} value={lot.code} className="bg-slate-900 text-white">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <label htmlFor={priceInputId} className="text-xs font-bold text-slate-400 uppercase tracking-wider">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <label htmlFor={downPaymentInputId} className="text-xs font-bold text-slate-400 uppercase tracking-wider">
              ...
              {[12, 24, 36, 48].map((term) => (
                <button
                  ...
                  className={`py-3 px-3 rounded-xl text-xs font-bold transition-all cursor-pointer ${
                    months === term
                      ? 'bg-[#25D366] text-slate-950 font-black shadow-lg scale-102'
        ...
        <div className="lg:col-span-5 border-t lg:border-t-0 lg:border-l border-slate-800 pt-6 lg:pt-0 lg:pl-10 space-y-6">
          <div className="space-y-3 pb-6 border-b border-slate-800/80 text-xs">
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-4xl sm:text-5xl font-black font-mono text-[#25D366]">
                ${monthlyQuota.toLocaleString()}
              </span>
              <span className="text-sm font-medium text-slate-400">USD / mes</span>
            </div>
          ...
          <div className="pt-2">
            <a
              ...
              className="w-full flex items-center justify-center gap-2.5 py-4 px-6 rounded-2xl bg-[#25D366] hover:bg-[#20bd5a] text-slate-950 font-black text-sm shadow-[0_4px_20px_rgba(37,211,102,0.3)] hover:scale-102 active:scale-95 transition-all cursor-pointer whitespace-nowrap"
            >
